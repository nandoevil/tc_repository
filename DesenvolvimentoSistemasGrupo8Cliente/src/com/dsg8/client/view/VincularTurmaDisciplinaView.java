...
public class VincularTurmaDisciplinaView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VincularTurmaDisciplinaView window = new VincularTurmaDisciplinaView();
	 ...
	 */
	public VincularTurmaDisciplinaView() {
		initialize();
	}
